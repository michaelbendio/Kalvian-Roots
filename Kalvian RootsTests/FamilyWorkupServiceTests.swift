...
final class FamilyWorkupServiceTests: XCTestCase {
    ...
    func testWorkupProposesApprovedFamilySearchIdSourceUpdateForMatchedChild() throws {
        ...
        XCTAssertTrue(html.contains("review-queue-table"))
        XCTAssertTrue(html.contains("<th>Type</th>"))
        XCTAssertTrue(html.contains("<th>Person</th>"))
        XCTAssertTrue(html.contains("<td>Source update</td>"))
        XCTAssertTrue(html.contains("<td>Liisa</td>"))
        XCTAssertTrue(html.contains("<td>Missing in HisKi</td>"))
        XCTAssertTrue(html.contains("<td>1760-06-12</td>"))
        ...
        XCTAssertTrue(familyHTML.contains("class=\"family-content\""))
        XCTAssertTrue(familyHTML.contains(">Liisa</a>"))
        XCTAssertTrue(familyHTML.contains("&lt;AB12-CD&gt;"))
        XCTAssertFalse(familyHTML.contains(#"id="family-review-queue""#))
        XCTAssertFalse(familyHTML.contains(#"id="children-comparison""#))
    }
    ...
    func testWorkupProposesReviewWhenJuuretAndFamilySearchIdsDiffer() throws {
        ...
        XCTAssertTrue(html.contains("review-queue-table"))
        XCTAssertTrue(html.contains("<td>ID mismatch</td>"))
        XCTAssertTrue(html.contains("<td>Maria</td>"))
        XCTAssertTrue(html.contains("<td>Missing in HisKi</td>"))
        XCTAssertTrue(html.contains("<td>1696-02-12</td>"))
