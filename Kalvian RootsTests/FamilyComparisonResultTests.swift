...
final class FamilySearchDOMServiceTests: XCTestCase {
    ...
    func testServerRenderedHiskiOnlyChildDateLinksUseCachedParentlessHiskiRoute() {
        ...
        XCTAssertTrue(html.contains(#"<a href="/family/HISKI%20ONLY%201/hiski?"#))
        XCTAssertTrue(html.contains(#"class="date-link""#))
    ...
    func testServerRenderedFamilySearchOnlyChildDateLinksUseCachedParentlessHiskiRoute() {
        ...
        XCTAssertTrue(html.contains(#"class="family-line child-line comparison-only-child""#))
        XCTAssertTrue(html.contains(#"<a href="/family/FS%20ONLY%201/hiski?"#))
        XCTAssertTrue(html.contains(#"class="date-link""#))
        ...
        XCTAssertTrue(html.contains("name=Lucas"))
