...
final class FamilySearchDOMServiceTests: XCTestCase {
    ...
    func testAtlasExtractorIncludesCallbackAndCardLineParser() {
        ...
        XCTAssertTrue(script.contains("function updateExtractionProgress(message)"))
        XCTAssertTrue(script.contains("function clearExtractionProgress()"))
        XCTAssertTrue(script.contains("Kalvian Roots is extracting FamilySearch child"))
        XCTAssertTrue(script.contains("date not found yet"))
        XCTAssertTrue(script.contains("birth dates ' + selectedBirthDateCount + '/' + children.length"))
        ...
        XCTAssertTrue(script.contains("function extractChildDetailsFromFetchedHTML(summary, notes)"))
        XCTAssertTrue(script.contains("function extractChildDetailsFromRenderedDetailsPage(summary, notes)"))
        XCTAssertTrue(script.contains("new DOMParser().parseFromString(html, 'text/html')"))
        XCTAssertTrue(script.contains("extractionSource: 'detailsHTML'"))
        XCTAssertTrue(script.contains("extractionSource: 'detailsPage'"))
        XCTAssertTrue(script.contains("details HTML fetched"))
        XCTAssertTrue(script.contains("using hidden child details page extraction"))
        ...
        XCTAssertTrue(script.contains("for (const element of [control, panel])"))
        ...
        XCTAssertTrue(script.contains("await closeChildPanel(panel, control);"))
        XCTAssertFalse(script.contains("return await extractChildDetailsFromPanel(summary, notes);"))
        ...
        XCTAssertTrue(script.contains("The parent"))
        XCTAssertTrue(script.contains("summary only exposes year spans"))
