...
final class FamilyContentViewTests: XCTestCase {
    ...
    func testBrowserNavigationOmitsHomeButtonAndSourceIconTogglesSourcePanel() {
        ...
        XCTAssertTrue(familyHTML.contains(#"href="/family/TEST%201/hiski-birth-search" class="nav-btn" title="HisKi birth search" aria-label="HisKi birth search"><svg class="nav-icon""#))
        ...
        XCTAssertTrue(sourceHTML.contains(#"href="/family/TEST%201/hiski-birth-search" class="nav-btn" title="HisKi birth search" aria-label="HisKi birth search"><svg class="nav-icon""#))
    }
