...
1. Click "Open FamilySearch in Kalvian Roots".
2. Sign in inside the visible FamilySearch WebKit window if needed.
3. Confirm the window is on the parent Details page.
4. Click "Extract in-app FamilySearch".
